import { IndicatorResult, MicrostructureState, MarketRegimeState, SignalResult, SignalType, HunterState } from '@athena/shared';
import { ScreenerConfig } from './ScreenerConfig';

/**
 * SignalEngine - ATHENA AI v2.0 Decision Engine
 *
